...
void holo::utils::BuildShearOrthographicMatrix2(double Xleft, double Xright, double Ybot, double Ytop,
	double n, double f, double q,
	float m[16])
{
	/* Build a row-major (C-style) double frustum perspective matrix */
...
void holo::utils::BuildDblPerspectiveMatrix(double Xleft, double Xright, double Ybot, double Ytop,
...
void holo::utils::BuildDblPerspectiveMatrix2(double Xleft, double Xright, double Ybot, double Ytop,
	double n, double f, double p,
	float m[16])
{
	/* Build a row-major (C-style) double frustum perspective matrix */
...
void holo::utils::BuildPerspectiveMatrix(double fieldOfView,
	double aspectRatio,
...
void holo::utils::BuildLookAtMatrix(double eyex, double eyey, double eyez,
...
void holo::utils::MakeRotateMatrix(float angle,
...
void holo::utils::MakeTranslateMatrix(float x, float y, float z, float m[16])
{
...
/* Build a row-major (C-style) 4x4 matrix transform based on the
parameters for glTranslatef. */
void holo::utils::MakeScaleMatrix(float x, float y, float z, float m[16])
{
...
void holo::utils::MultMatrix(float dst[16],
...
void holo::utils::TransposeMatrix(float *out, const float *m){
	out[0] = m[0];
	out[1] = m[4];
	out[2] = m[8];
	out[3] = m[12];
...
void holo::utils::InvertMatrix(float *out, const float *m)
{
...
void holo::utils::Transform(float dst[4],
