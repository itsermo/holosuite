...
#define HOLO_AUDIO_DEFAULT_NUM_FRAMES HOLO_AUDIO_DEFAULT_ENCODE_FRAME_SIZE * 2
#endif
...
namespace holo
{
	...
	namespace render
	{
		...
		typedef enum
		{
			SIMPLE_OBJECT_CIRCLE = 0,
			SIMPLE_OBJECT_SQUARE = 1,
			SIMPLE_OBJECT_TRIANGLE = 2,
			SIMPLE_OBJECT_POINTER = 3
		} SIMPLE_OBJECT;
