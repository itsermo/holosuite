...
#define HOLO_RENDER_DSCP2_VIEW_RENDER_HOLOGRAM_PLANE_WIDTH_MM 150.f
#define HOLO_RENDER_DSCP2_VIEW_RENDER_HOLOGRAM_PLANE_HEIGHT_MM 75.f
#define HOLO_RENDER_DSCP2_PLANE_NEAR 0.01f
#define HOLO_RENDER_DSCP2_PLANE_FAR 400.f
...
#define HOLO_RENDER_DSCP2_CG_PARALLAX_VIEW_VERTEX_PROGRAM_FILENAME "../shaders/HoloRenderDSCP2CloudVertexShader.cg"
#define HOLO_RENDER_DSCP2_CG_PARALLAX_VIEW_FRAGMENT_PROGRAM_NAME "HoloRenderDSCP2CloudFragmentShader"
#define HOLO_RENDER_DSCP2_CG_PARALLAX_VIEW_FRAGMENT_PROGRAM_FILENAME "../shaders/HoloRenderDSCP2CloudFragmentShader.cg"

#define HOLO_RENDER_DSCP2_CG_FRINGE_PATTERN_VERTEX_PROGRAM_NAME "HoloRenderDSCP2FringeVertexShader"
#define HOLO_RENDER_DSCP2_CG_FRINGE_PATTERN_VERTEX_PROGRAM_FILENAME "../shaders/HoloRenderDSCP2FringeVertexShader.cg"
#define HOLO_RENDER_DSCP2_CG_FRINGE_PATTERN_FRAGMENT_PROGRAM_NAME "HoloRenderDSCP2FringeFragmentShader"
#define HOLO_RENDER_DSCP2_CG_FRINGE_PATTERN_FRAGMENT_PROGRAM_FILENAME "../shaders/HoloRenderDSCP2FringeFragmentShader.cg"
